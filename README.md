...
explicitement auditées. La plage actuelle couvre **4.2 à 5.2** ; la 4.3 ajoute
...
dans `rendering.roles` ce qu'une clé de couleur peint, et la 5.2 ouvre chaque
axe de `structure.sizing` à une référence de token. Button et Alert
